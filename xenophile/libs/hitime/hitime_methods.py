...
def main(MPI=None, options = None, queue = None):

	if queue:
		msg = 'Begin processing file: %s' %options.inputFile
		queue.put(msg)
	...
	if queue:
		msg = 'Finished processing file: %s' %options.inputFile
		queue.put(msg)
