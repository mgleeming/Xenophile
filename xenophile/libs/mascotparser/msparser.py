...
class ms_errs(_object):
    ...
    ERR_MSP_FAIL_UTIME = _msparser.ms_errs_ERR_MSP_FAIL_UTIME
    ...
    ERR_MSP_SECURITY_CMDLINE_CGI = _msparser.ms_errs_ERR_MSP_SECURITY_CMDLINE_CGI
    ...
    ERR_MSP_QUANTITATION_NOMETHOD = _msparser.ms_errs_ERR_MSP_QUANTITATION_NOMETHOD
    ERR_MSP_QUANTITATION_BADMETHOD = _msparser.ms_errs_ERR_MSP_QUANTITATION_BADMETHOD
    ERR_MSP_QUANTITATION_BADCOMPONENT = _msparser.ms_errs_ERR_MSP_QUANTITATION_BADCOMPONENT
    ...
    ERR_MSP_MS1QUANTITATION_HITREF_NEW = _msparser.ms_errs_ERR_MSP_MS1QUANTITATION_HITREF_NEW
    ERR_MSP_MS1QUANTITATION_HITREF_DROP = _msparser.ms_errs_ERR_MSP_MS1QUANTITATION_HITREF_DROP
    ERR_MSP_MS1QUANTITATION_FAILEDINIT = _msparser.ms_errs_ERR_MSP_MS1QUANTITATION_FAILEDINIT
    ...
    ERR_MSP_HTTP_BADHTTPSTATUS = _msparser.ms_errs_ERR_MSP_HTTP_BADHTTPSTATUS
    ERR_MSP_HTTP_ERROR = _msparser.ms_errs_ERR_MSP_HTTP_ERROR
    ERR_MSP_HTTP_SESSIONALREADYOPEN = _msparser.ms_errs_ERR_MSP_HTTP_SESSIONALREADYOPEN
...
class ms_fileutilities(_object):
    ...
    __swig_getmethods__["setLastModificationTime"] = lambda x: _msparser.ms_fileutilities_setLastModificationTime
    if _newclass:setLastModificationTime = staticmethod(_msparser.ms_fileutilities_setLastModificationTime)
    ...
    CMD_ARGUMENT_PARSE_OK = _msparser.ms_fileutilities_CMD_ARGUMENT_PARSE_OK
    CMD_ARGUMENT_PARSE_UNBALANCED = _msparser.ms_fileutilities_CMD_ARGUMENT_PARSE_UNBALANCED
    CMD_ARGUMENT_PARSE_COLLISION = _msparser.ms_fileutilities_CMD_ARGUMENT_PARSE_COLLISION
    CMD_ARGUMENT_PARSE_INVALIDCHAR = _msparser.ms_fileutilities_CMD_ARGUMENT_PARSE_INVALIDCHAR
    __swig_getmethods__["parseCommandLineArgumentString"] = lambda x: _msparser.ms_fileutilities_parseCommandLineArgumentString
    if _newclass:parseCommandLineArgumentString = staticmethod(_msparser.ms_fileutilities_parseCommandLineArgumentString)
...
def ms_fileutilities_setLastModificationTime(*args):
  return _msparser.ms_fileutilities_setLastModificationTime(*args)
ms_fileutilities_setLastModificationTime = _msparser.ms_fileutilities_setLastModificationTime
...
def ms_fileutilities_parseCommandLineArgumentString(*args):
  return _msparser.ms_fileutilities_parseCommandLineArgumentString(*args)
ms_fileutilities_parseCommandLineArgumentString = _msparser.ms_fileutilities_parseCommandLineArgumentString
...
class ms_connection_settings(_object):
    ...
    PROXY_TYPE_ENVIRONMENT = _msparser.ms_connection_settings_PROXY_TYPE_ENVIRONMENT
    ...
    def setUseHTTPProxyForFTP(self, *args): return _msparser.ms_connection_settings_setUseHTTPProxyForFTP(self, *args)
    ...
    def isUseHTTPProxyForFTP(self): return _msparser.ms_connection_settings_isUseHTTPProxyForFTP(self)
    ...
    def getProxySettings(self, *args): return _msparser.ms_connection_settings_getProxySettings(self, *args)
    __swig_getmethods__["proxyTypeStringToEnum"] = lambda x: _msparser.ms_connection_settings_proxyTypeStringToEnum
    if _newclass:proxyTypeStringToEnum = staticmethod(_msparser.ms_connection_settings_proxyTypeStringToEnum)
    __swig_getmethods__["proxyTypeToString"] = lambda x: _msparser.ms_connection_settings_proxyTypeToString
    if _newclass:proxyTypeToString = staticmethod(_msparser.ms_connection_settings_proxyTypeToString)
...
def ms_connection_settings_proxyTypeStringToEnum(*args):
  return _msparser.ms_connection_settings_proxyTypeStringToEnum(*args)
ms_connection_settings_proxyTypeStringToEnum = _msparser.ms_connection_settings_proxyTypeStringToEnum

def ms_connection_settings_proxyTypeToString(*args):
  return _msparser.ms_connection_settings_proxyTypeToString(*args)
ms_connection_settings_proxyTypeToString = _msparser.ms_connection_settings_proxyTypeToString
...
class ms_tinycdb(ms_errors):
    ...
    def isCreating(self): return _msparser.ms_tinycdb_isCreating(self)
...
class ms_clusterparams(ms_customproperty):
    ...
    def getNodeSequenceDatabaseDir(self): return _msparser.ms_clusterparams_getNodeSequenceDatabaseDir(self)
    def setNodeSequenceDatabaseDir(self, *args): return _msparser.ms_clusterparams_setNodeSequenceDatabaseDir(self, *args)
...
class ms_mascotoptions(ms_customproperty):
    ...
    MASS_DECIMAL_PLACES = _msparser.ms_mascotoptions_MASS_DECIMAL_PLACES
    def __init__(self, *args): 
    ...
    def getProxyType(self): return _msparser.ms_mascotoptions_getProxyType(self)
    def setProxyType(self, *args): return _msparser.ms_mascotoptions_setProxyType(self, *args)
    def isUseHTTPProxyForFTP(self): return _msparser.ms_mascotoptions_isUseHTTPProxyForFTP(self)
    def setUseHTTPProxyForFTP(self, *args): return _msparser.ms_mascotoptions_setUseHTTPProxyForFTP(self, *args)
    ...
    def getMaxPepModArrangements(self): return _msparser.ms_mascotoptions_getMaxPepModArrangements(self)
    def setMaxPepModArrangements(self, *args): return _msparser.ms_mascotoptions_setMaxPepModArrangements(self, *args)
    ...
    def getMaxPepNumModifiableSites(self): return _msparser.ms_mascotoptions_getMaxPepNumModifiableSites(self)
    def setMaxPepNumModifiableSites(self, *args): return _msparser.ms_mascotoptions_setMaxPepNumModifiableSites(self, *args)
    ...
    def getSVGSpectrumSwitch(self): return _msparser.ms_mascotoptions_getSVGSpectrumSwitch(self)
    def setSVGSpectrumSwitch(self, *args): return _msparser.ms_mascotoptions_setSVGSpectrumSwitch(self, *args)
...
class ms_datfile(ms_errors):
    ...
    def read_buffer(self, *args): return _msparser.ms_datfile_read_buffer(self, *args)
...
class ms_umod_configfile(ms_errors):
    ...
    def applyVisibility(self, *args): return _msparser.ms_umod_configfile_applyVisibility(self, *args)
...
class ms_modification(ms_customproperty):
    ...
    def inShortList(self): return _msparser.ms_modification_inShortList(self)
    def setInShortList(self, *args): return _msparser.ms_modification_setInShortList(self, *args)
    def inLongList(self): return _msparser.ms_modification_inLongList(self)
    def setInLongList(self, *args): return _msparser.ms_modification_setInLongList(self, *args)
    def inErrorTolerant(self): return _msparser.ms_modification_inErrorTolerant(self)
    def setInErrorTolerant(self, *args): return _msparser.ms_modification_setInErrorTolerant(self, *args)
...
class ms_modvector(_object):
    ...
    def appendModifications(self, *args): return _msparser.ms_modvector_appendModifications(self, *args)
    def getModificationByNumber(self, *args): return _msparser.ms_modvector_getModificationByNumber(self, *args)
    def getModificationByName(self, *args): return _msparser.ms_modvector_getModificationByName(self, *args)
...
class ms_modfile(ms_errors):
    ...
    def saveToString(self, *args): return _msparser.ms_modfile_saveToString(self, *args)
...
class ms_security_tasks(ms_errors):
    ...
    SECTASK_DATAURLPROTOCOLS = _msparser.ms_security_tasks_SECTASK_DATAURLPROTOCOLS
    SECTASK_DATAURLMAXSIZE = _msparser.ms_security_tasks_SECTASK_DATAURLMAXSIZE
    ...
    def isTaskExists(self, *args): return _msparser.ms_security_tasks_isTaskExists(self, *args)
...
class ms_security(ms_errors):
    ...
    def isUserExists(self, *args): return _msparser.ms_security_isUserExists(self, *args)
    ...
    def isTaskExists(self, *args): return _msparser.ms_security_isTaskExists(self, *args)
...
class ms_quant_average(ms_quant_parameters):
    ...
    def haveReferenceDatabase(self): return _msparser.ms_quant_average_haveReferenceDatabase(self)
    def getReferenceDatabase(self): return _msparser.ms_quant_average_getReferenceDatabase(self)
    def setReferenceDatabase(self, *args): return _msparser.ms_quant_average_setReferenceDatabase(self, *args)
    def dropReferenceDatabase(self): return _msparser.ms_quant_average_dropReferenceDatabase(self)
    def getReferenceDatabaseSchemaType(self): return _msparser.ms_quant_average_getReferenceDatabaseSchemaType(self)
...
class ms_quant_method(ms_xml_IValidatable):
    ...
    def getLocalModifications(self, *args): return _msparser.ms_quant_method_getLocalModifications(self, *args)
...
class ms_quant_stats(_object):
    ...
    __swig_getmethods__["arithmeticStandardErrorOfMean"] = lambda x: _msparser.ms_quant_stats_arithmeticStandardErrorOfMean
    if _newclass:arithmeticStandardErrorOfMean = staticmethod(_msparser.ms_quant_stats_arithmeticStandardErrorOfMean)
    ...
    __swig_getmethods__["arithmeticStandardErrorOfMedian"] = lambda x: _msparser.ms_quant_stats_arithmeticStandardErrorOfMedian
    if _newclass:arithmeticStandardErrorOfMedian = staticmethod(_msparser.ms_quant_stats_arithmeticStandardErrorOfMedian)
    ...
    __swig_getmethods__["weightedArithmeticStandardError"] = lambda x: _msparser.ms_quant_stats_weightedArithmeticStandardError
    if _newclass:weightedArithmeticStandardError = staticmethod(_msparser.ms_quant_stats_weightedArithmeticStandardError)
    ...
    __swig_getmethods__["calculateNormalWeightedPvalue"] = lambda x: _msparser.ms_quant_stats_calculateNormalWeightedPvalue
    if _newclass:calculateNormalWeightedPvalue = staticmethod(_msparser.ms_quant_stats_calculateNormalWeightedPvalue)
    __swig_getmethods__["medianStandardErrorCorrection"] = lambda x: _msparser.ms_quant_stats_medianStandardErrorCorrection
    if _newclass:medianStandardErrorCorrection = staticmethod(_msparser.ms_quant_stats_medianStandardErrorCorrection)
...
def ms_quant_stats_arithmeticStandardErrorOfMean(*args):
  return _msparser.ms_quant_stats_arithmeticStandardErrorOfMean(*args)
ms_quant_stats_arithmeticStandardErrorOfMean = _msparser.ms_quant_stats_arithmeticStandardErrorOfMean
...
def ms_quant_stats_arithmeticStandardErrorOfMedian(*args):
  return _msparser.ms_quant_stats_arithmeticStandardErrorOfMedian(*args)
ms_quant_stats_arithmeticStandardErrorOfMedian = _msparser.ms_quant_stats_arithmeticStandardErrorOfMedian
...
def ms_quant_stats_weightedArithmeticStandardError(*args):
  return _msparser.ms_quant_stats_weightedArithmeticStandardError(*args)
ms_quant_stats_weightedArithmeticStandardError = _msparser.ms_quant_stats_weightedArithmeticStandardError
...
def ms_quant_stats_calculateNormalWeightedPvalue(*args):
  return _msparser.ms_quant_stats_calculateNormalWeightedPvalue(*args)
ms_quant_stats_calculateNormalWeightedPvalue = _msparser.ms_quant_stats_calculateNormalWeightedPvalue

def ms_quant_stats_medianStandardErrorCorrection(*args):
  return _msparser.ms_quant_stats_medianStandardErrorCorrection(*args)
ms_quant_stats_medianStandardErrorCorrection = _msparser.ms_quant_stats_medianStandardErrorCorrection
...
class ms_peptide_quant_key(_object):
    ...
    def isNil(self): return _msparser.ms_peptide_quant_key_isNil(self)
    __swig_getmethods__["fromSerialisedString"] = lambda x: _msparser.ms_peptide_quant_key_fromSerialisedString
    if _newclass:fromSerialisedString = staticmethod(_msparser.ms_peptide_quant_key_fromSerialisedString)
    def serialise(self): return _msparser.ms_peptide_quant_key_serialise(self)
    __swig_getmethods__["serialisationFormatVersion"] = lambda x: _msparser.ms_peptide_quant_key_serialisationFormatVersion
    if _newclass:serialisationFormatVersion = staticmethod(_msparser.ms_peptide_quant_key_serialisationFormatVersion)
...
def ms_peptide_quant_key_fromSerialisedString(*args):
  return _msparser.ms_peptide_quant_key_fromSerialisedString(*args)
ms_peptide_quant_key_fromSerialisedString = _msparser.ms_peptide_quant_key_fromSerialisedString

def ms_peptide_quant_key_serialisationFormatVersion():
  return _msparser.ms_peptide_quant_key_serialisationFormatVersion()
ms_peptide_quant_key_serialisationFormatVersion = _msparser.ms_peptide_quant_key_serialisationFormatVersion
...
class ms_protein_quant_ratio(_object):
    ...
    def getStandardDeviation_only(self): return _msparser.ms_protein_quant_ratio_getStandardDeviation_only(self)
    def getStandardDeviation(self): return _msparser.ms_protein_quant_ratio_getStandardDeviation(self)
    def getStandardError_only(self): return _msparser.ms_protein_quant_ratio_getStandardError_only(self)
    def getStandardError(self): return _msparser.ms_protein_quant_ratio_getStandardError(self)
    ...
    def getHypothesisPvalue_only(self): return _msparser.ms_protein_quant_ratio_getHypothesisPvalue_only(self)
    ...
    def getNormalityPvalue_only(self): return _msparser.ms_protein_quant_ratio_getNormalityPvalue_only(self)
    ...
    __swig_getmethods__["fromSerialisedString"] = lambda x: _msparser.ms_protein_quant_ratio_fromSerialisedString
    if _newclass:fromSerialisedString = staticmethod(_msparser.ms_protein_quant_ratio_fromSerialisedString)
    def serialise(self): return _msparser.ms_protein_quant_ratio_serialise(self)
    __swig_getmethods__["serialisationFormatVersion"] = lambda x: _msparser.ms_protein_quant_ratio_serialisationFormatVersion
    if _newclass:serialisationFormatVersion = staticmethod(_msparser.ms_protein_quant_ratio_serialisationFormatVersion)
...
def ms_protein_quant_ratio_fromSerialisedString(*args):
  return _msparser.ms_protein_quant_ratio_fromSerialisedString(*args)
ms_protein_quant_ratio_fromSerialisedString = _msparser.ms_protein_quant_ratio_fromSerialisedString

def ms_protein_quant_ratio_serialisationFormatVersion():
  return _msparser.ms_protein_quant_ratio_serialisationFormatVersion()
ms_protein_quant_ratio_serialisationFormatVersion = _msparser.ms_protein_quant_ratio_serialisationFormatVersion
...
class ms_umod_modification(ms_xml_IValidatable):
    ...
    def getSpecificityBySite(self, *args): return _msparser.ms_umod_modification_getSpecificityBySite(self, *args)
    ...
    def isPrivate(self): return _msparser.ms_umod_modification_isPrivate(self)
    def setPrivate(self, *args): return _msparser.ms_umod_modification_setPrivate(self, *args)
    def isPrivacyEnabled(self): return _msparser.ms_umod_modification_isPrivacyEnabled(self)
    def setPrivacyEnabled(self, *args): return _msparser.ms_umod_modification_setPrivacyEnabled(self, *args)
...
class ms_umod_specificity(_object):
    ...
    def inShortList(self): return _msparser.ms_umod_specificity_inShortList(self)
    def showInShortList(self, *args): return _msparser.ms_umod_specificity_showInShortList(self, *args)
    def inLongList(self): return _msparser.ms_umod_specificity_inLongList(self)
    def showInLongList(self, *args): return _msparser.ms_umod_specificity_showInLongList(self, *args)
    def inErrorTolerant(self): return _msparser.ms_umod_specificity_inErrorTolerant(self)
    def useInErrorTolerant(self, *args): return _msparser.ms_umod_specificity_useInErrorTolerant(self, *args)
...
class ms_peptide(_object):
    ...
    def getLocalModsStr(self): return _msparser.ms_peptide_getLocalModsStr(self)
    def setLocalModsStr(self, *args): return _msparser.ms_peptide_setLocalModsStr(self, *args)
    ...
    def getLocalModsNlStr(self): return _msparser.ms_peptide_getLocalModsNlStr(self)
    def setLocalModsNlStr(self, *args): return _msparser.ms_peptide_setLocalModsNlStr(self, *args)
    ...
    def getAnyProteinTermination(self, *args): return _msparser.ms_peptide_getAnyProteinTermination(self, *args)
...
class ms_mascotresfile(ms_errors):
    ...
    RESFILE_CACHE_IGNORE_DATE_CHANGE = _msparser.ms_mascotresfile_RESFILE_CACHE_IGNORE_DATE_CHANGE
...
class ms_protein(_object):
    ...
    DPF_NODUPSAMEQUERY = _msparser.ms_protein_DPF_NODUPSAMEQUERY
    def __init__(self, *args): 
    ...
    def getMemberNumber(self): return _msparser.ms_protein_getMemberNumber(self)
    ...
    def getNumDistinctPeptideRepeats(self, *args): return _msparser.ms_protein_getNumDistinctPeptideRepeats(self, *args)
    def getDistinctPeptide(self, *args): return _msparser.ms_protein_getDistinctPeptide(self, *args)
...
class ms_mascotresults(_object):
    ...
    QCS_OK = _msparser.ms_mascotresults_QCS_OK
    QCS_OK_NO_MATCH = _msparser.ms_mascotresults_QCS_OK_NO_MATCH
    QCS_ERROR_NO_METHOD = _msparser.ms_mascotresults_QCS_ERROR_NO_METHOD
    QCS_ERROR_NO_COMPONENTS = _msparser.ms_mascotresults_QCS_ERROR_NO_COMPONENTS
    QCS_ERROR_BAD_COMPONENT_NAME = _msparser.ms_mascotresults_QCS_ERROR_BAD_COMPONENT_NAME
    ...
    def getDiscoveredLocalModNames(self): return _msparser.ms_mascotresults_getDiscoveredLocalModNames(self)
    def getNumDiscoveredLocalMods(self, *args): return _msparser.ms_mascotresults_getNumDiscoveredLocalMods(self, *args)
    ...
    def getQuantitationComponentForPeptide(self, *args): return _msparser.ms_mascotresults_getQuantitationComponentForPeptide(self, *args)
...
class ms_proteinsummary(ms_mascotresults):
    ...
    def getQuantitationComponentForPeptide(self, *args): return _msparser.ms_proteinsummary_getQuantitationComponentForPeptide(self, *args)
ms_proteinsummary_swigregister = _msparser.ms_proteinsummary_swigregister
ms_proteinsummary_swigregister(ms_proteinsummary)

class ms_percolator_score(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_percolator_score, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ms_percolator_score, name)
    __repr__ = _swig_repr
    __swig_setmethods__["percolatorScore"] = _msparser.ms_percolator_score_percolatorScore_set
    __swig_getmethods__["percolatorScore"] = _msparser.ms_percolator_score_percolatorScore_get
    if _newclass:percolatorScore = _swig_property(_msparser.ms_percolator_score_percolatorScore_get, _msparser.ms_percolator_score_percolatorScore_set)
    __swig_setmethods__["qValue"] = _msparser.ms_percolator_score_qValue_set
    __swig_getmethods__["qValue"] = _msparser.ms_percolator_score_qValue_get
    if _newclass:qValue = _swig_property(_msparser.ms_percolator_score_qValue_get, _msparser.ms_percolator_score_qValue_set)
    __swig_setmethods__["percolatorPEP"] = _msparser.ms_percolator_score_percolatorPEP_set
    __swig_getmethods__["percolatorPEP"] = _msparser.ms_percolator_score_percolatorPEP_get
    if _newclass:percolatorPEP = _swig_property(_msparser.ms_percolator_score_percolatorPEP_get, _msparser.ms_percolator_score_percolatorPEP_set)
    __swig_setmethods__["mascotScore"] = _msparser.ms_percolator_score_mascotScore_set
    __swig_getmethods__["mascotScore"] = _msparser.ms_percolator_score_mascotScore_get
    if _newclass:mascotScore = _swig_property(_msparser.ms_percolator_score_mascotScore_get, _msparser.ms_percolator_score_mascotScore_set)
    def __init__(self): 
        this = _msparser.new_ms_percolator_score()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _msparser.delete_ms_percolator_score
    __del__ = lambda self : None;
ms_percolator_score_swigregister = _msparser.ms_percolator_score_swigregister
ms_percolator_score_swigregister(ms_percolator_score)
...
class ms_peptidesummary(ms_mascotresults):
    ...
    MSPEPSUM_CACHE_IGNORE_DATE_CHANGE = _msparser.ms_peptidesummary_MSPEPSUM_CACHE_IGNORE_DATE_CHANGE
    MSPEPSUM_REMOVE_CHIMERIC_DUPES = _msparser.ms_peptidesummary_MSPEPSUM_REMOVE_CHIMERIC_DUPES
    ...
    BUGFIX_11499 = _msparser.ms_peptidesummary_BUGFIX_11499
    BUGFIX_11856 = _msparser.ms_peptidesummary_BUGFIX_11856
    CACHE_MISSING_RESFILE = _msparser.ms_peptidesummary_CACHE_MISSING_RESFILE
    RESFILE_CACHE_FILE_NOT_PRESENT = _msparser.ms_peptidesummary_RESFILE_CACHE_FILE_NOT_PRESENT
    RESFILE_CACHE_BEING_CREATED = _msparser.ms_peptidesummary_RESFILE_CACHE_BEING_CREATED
    RESFILE_CACHE_DISABLED_IN_OPTIONS = _msparser.ms_peptidesummary_RESFILE_CACHE_DISABLED_IN_OPTIONS
    RESFILE_CACHE_VALID = _msparser.ms_peptidesummary_RESFILE_CACHE_VALID
    RESFILE_CACHE_CAN_CREATE = _msparser.ms_peptidesummary_RESFILE_CACHE_CAN_CREATE
    PEPSUMMARY_CACHE_FILE_NOT_PRESENT = _msparser.ms_peptidesummary_PEPSUMMARY_CACHE_FILE_NOT_PRESENT
    PEPSUMMARY_CACHE_BEING_CREATED = _msparser.ms_peptidesummary_PEPSUMMARY_CACHE_BEING_CREATED
    PEPSUMMARY_CACHE_DISABLED_IN_OPTIONS = _msparser.ms_peptidesummary_PEPSUMMARY_CACHE_DISABLED_IN_OPTIONS
    PEPSUMMARY_CACHE_VALID = _msparser.ms_peptidesummary_PEPSUMMARY_CACHE_VALID
    PEPSUMMARY_CACHE_CAN_CREATE = _msparser.ms_peptidesummary_PEPSUMMARY_CACHE_CAN_CREATE
    PEPSUMMARY_CACHE_STATUS_NOT_AVAILABLE = _msparser.ms_peptidesummary_PEPSUMMARY_CACHE_STATUS_NOT_AVAILABLE
    PEPSUMMARY_CACHE_NOT_FOR_PMF = _msparser.ms_peptidesummary_PEPSUMMARY_CACHE_NOT_FOR_PMF
    __swig_getmethods__["getCacheFilename"] = lambda x: _msparser.ms_peptidesummary_getCacheFilename
    if _newclass:getCacheFilename = staticmethod(_msparser.ms_peptidesummary_getCacheFilename)
    def __init__(self, *args): 
    ...
    __del__ = lambda self : None;
    def mascotresfile(self): return _msparser.ms_peptidesummary_mascotresfile(self)
    ...
    def getQuantitationComponentForPeptide(self, *args): return _msparser.ms_peptidesummary_getQuantitationComponentForPeptide(self, *args)
    ...
    def isPeptideModificationMatch(self, *args): return _msparser.ms_peptidesummary_isPeptideModificationMatch(self, *args)
    def isPeptideComponentMatch(self, *args): return _msparser.ms_peptidesummary_isPeptideComponentMatch(self, *args)
    def hasQuantMethod(self): return _msparser.ms_peptidesummary_hasQuantMethod(self)
    def getQuantMethod(self): return _msparser.ms_peptidesummary_getQuantMethod(self)
    ...
    __swig_getmethods__["testForSingleMatch"] = lambda x: _msparser.ms_peptidesummary_testForSingleMatch
    if _newclass:testForSingleMatch = staticmethod(_msparser.ms_peptidesummary_testForSingleMatch)
ms_peptidesummary_swigregister = _msparser.ms_peptidesummary_swigregister
ms_peptidesummary_swigregister(ms_peptidesummary)

def ms_peptidesummary_getCacheFilename(*args):
  return _msparser.ms_peptidesummary_getCacheFilename(*args)
ms_peptidesummary_getCacheFilename = _msparser.ms_peptidesummary_getCacheFilename
...
def ms_peptidesummary_testForSingleMatch(*args):
  return _msparser.ms_peptidesummary_testForSingleMatch(*args)
ms_peptidesummary_testForSingleMatch = _msparser.ms_peptidesummary_testForSingleMatch
...
class ms_inputquery(_object):
    ...
    def getNumberOfLocalVarMods(self): return _msparser.ms_inputquery_getNumberOfLocalVarMods(self)
    def getLocalVarModName(self, *args): return _msparser.ms_inputquery_getLocalVarModName(self, *args)
    ...
    __swig_getmethods__["splitIT_MODS"] = lambda x: _msparser.ms_inputquery_splitIT_MODS
    if _newclass:splitIT_MODS = staticmethod(_msparser.ms_inputquery_splitIT_MODS)
ms_inputquery_swigregister = _msparser.ms_inputquery_swigregister
ms_inputquery_swigregister(ms_inputquery)

def ms_inputquery_splitIT_MODS(*args):
  return _msparser.ms_inputquery_splitIT_MODS(*args)
ms_inputquery_splitIT_MODS = _msparser.ms_inputquery_splitIT_MODS
...
class ms_searchparams(_object):
    ...
    def getDATAURL(self): return _msparser.ms_searchparams_getDATAURL(self)
...
class ms_http_helper(ms_errors):
    ...
    def httpBufferedOpen(self, *args): return _msparser.ms_http_helper_httpBufferedOpen(self, *args)
    def httpBufferedGetString(self, *args): return _msparser.ms_http_helper_httpBufferedGetString(self, *args)
    def httpBufferedClose(self): return _msparser.ms_http_helper_httpBufferedClose(self)
    def httpGetHeader(self, *args): return _msparser.ms_http_helper_httpGetHeader(self, *args)
    __swig_getmethods__["getHeaderValue"] = lambda x: _msparser.ms_http_helper_getHeaderValue
    if _newclass:getHeaderValue = staticmethod(_msparser.ms_http_helper_getHeaderValue)
ms_http_helper_swigregister = _msparser.ms_http_helper_swigregister
ms_http_helper_swigregister(ms_http_helper)

def ms_http_helper_getHeaderValue(*args):
  return _msparser.ms_http_helper_getHeaderValue(*args)
ms_http_helper_getHeaderValue = _msparser.ms_http_helper_getHeaderValue
...
class ms_matrix(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_matrix, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ms_matrix, name)
    __repr__ = _swig_repr
    __swig_getmethods__["diagonalMatrix"] = lambda x: _msparser.ms_matrix_diagonalMatrix
    if _newclass:diagonalMatrix = staticmethod(_msparser.ms_matrix_diagonalMatrix)
    __swig_getmethods__["identityMatrix"] = lambda x: _msparser.ms_matrix_identityMatrix
    if _newclass:identityMatrix = staticmethod(_msparser.ms_matrix_identityMatrix)
    __swig_getmethods__["rowMatrix"] = lambda x: _msparser.ms_matrix_rowMatrix
    if _newclass:rowMatrix = staticmethod(_msparser.ms_matrix_rowMatrix)
    __swig_getmethods__["columnMatrix"] = lambda x: _msparser.ms_matrix_columnMatrix
    if _newclass:columnMatrix = staticmethod(_msparser.ms_matrix_columnMatrix)
    def __init__(self, *args): 
        this = _msparser.new_ms_matrix(*args)
        try: self.this.append(this)
        except: self.this = this
    def sizei(self): return _msparser.ms_matrix_sizei(self)
    def sizej(self): return _msparser.ms_matrix_sizej(self)
    def get(self, *args): return _msparser.ms_matrix_get(self, *args)
    def set(self, *args): return _msparser.ms_matrix_set(self, *args)
    def data(self): return _msparser.ms_matrix_data(self)
    def __eq__(self, *args): return _msparser.ms_matrix___eq__(self, *args)
    def __ne__(self, *args): return _msparser.ms_matrix___ne__(self, *args)
    def isZero(self): return _msparser.ms_matrix_isZero(self)
    def resize(self, *args): return _msparser.ms_matrix_resize(self, *args)
    def multiplyByRow(self, *args): return _msparser.ms_matrix_multiplyByRow(self, *args)
    def __mul__(self, *args): return _msparser.ms_matrix___mul__(self, *args)
    def transpose(self): return _msparser.ms_matrix_transpose(self)
    __swig_destroy__ = _msparser.delete_ms_matrix
    __del__ = lambda self : None;
ms_matrix_swigregister = _msparser.ms_matrix_swigregister
ms_matrix_swigregister(ms_matrix)

def ms_matrix_diagonalMatrix(*args):
  return _msparser.ms_matrix_diagonalMatrix(*args)
ms_matrix_diagonalMatrix = _msparser.ms_matrix_diagonalMatrix

def ms_matrix_identityMatrix(*args):
  return _msparser.ms_matrix_identityMatrix(*args)
ms_matrix_identityMatrix = _msparser.ms_matrix_identityMatrix

def ms_matrix_rowMatrix(*args):
  return _msparser.ms_matrix_rowMatrix(*args)
ms_matrix_rowMatrix = _msparser.ms_matrix_rowMatrix

def ms_matrix_columnMatrix(*args):
  return _msparser.ms_matrix_columnMatrix(*args)
ms_matrix_columnMatrix = _msparser.ms_matrix_columnMatrix

class ms_body(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_body, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ms_body, name)
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
ms_body_swigregister = _msparser.ms_body_swigregister
ms_body_swigregister(ms_body)

class ms_handle(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_handle, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ms_handle, name)
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_destroy__ = _msparser.delete_ms_handle
    __del__ = lambda self : None;
ms_handle_swigregister = _msparser.ms_handle_swigregister
ms_handle_swigregister(ms_handle)

class ms_xic(ms_handle):
    __swig_setmethods__ = {}
    for _s in [ms_handle]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_xic, name, value)
    __swig_getmethods__ = {}
    for _s in [ms_handle]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, ms_xic, name)
    __repr__ = _swig_repr
    PEAK_STATE_UNKNOWN = _msparser.ms_xic_PEAK_STATE_UNKNOWN
    PEAK_STATE_OK = _msparser.ms_xic_PEAK_STATE_OK
    PEAK_STATE_DISCARD = _msparser.ms_xic_PEAK_STATE_DISCARD
    __swig_getmethods__["getXmlCode"] = lambda x: _msparser.ms_xic_getXmlCode
    if _newclass:getXmlCode = staticmethod(_msparser.ms_xic_getXmlCode)
    __swig_getmethods__["getCodeFromXml"] = lambda x: _msparser.ms_xic_getCodeFromXml
    if _newclass:getCodeFromXml = staticmethod(_msparser.ms_xic_getCodeFromXml)
    def __init__(self, *args): 
        this = _msparser.new_ms_xic(*args)
        try: self.this.append(this)
        except: self.this = this
    def getPeakState(self): return _msparser.ms_xic_getPeakState(self)
    def hasIndexes(self): return _msparser.ms_xic_hasIndexes(self)
    def getPeakStartIndex(self): return _msparser.ms_xic_getPeakStartIndex(self)
    def getPeakEndIndex(self): return _msparser.ms_xic_getPeakEndIndex(self)
    def getRegionStartIndex(self): return _msparser.ms_xic_getRegionStartIndex(self)
    def getRegionEndIndex(self): return _msparser.ms_xic_getRegionEndIndex(self)
    def getStartIndex(self): return _msparser.ms_xic_getStartIndex(self)
    def getEndIndex(self): return _msparser.ms_xic_getEndIndex(self)
    def getPeakStartScanId(self): return _msparser.ms_xic_getPeakStartScanId(self)
    def getPeakEndScanId(self): return _msparser.ms_xic_getPeakEndScanId(self)
    def getRegionStartScanId(self): return _msparser.ms_xic_getRegionStartScanId(self)
    def getRegionEndScanId(self): return _msparser.ms_xic_getRegionEndScanId(self)
    def getStartScanId(self): return _msparser.ms_xic_getStartScanId(self)
    def getEndScanId(self): return _msparser.ms_xic_getEndScanId(self)
    def getUseTimeShift(self): return _msparser.ms_xic_getUseTimeShift(self)
    def getElutionTimeShift(self): return _msparser.ms_xic_getElutionTimeShift(self)
    def getRtPeakStart(self): return _msparser.ms_xic_getRtPeakStart(self)
    def getRtPeakEnd(self): return _msparser.ms_xic_getRtPeakEnd(self)
    def getRtRegionStart(self): return _msparser.ms_xic_getRtRegionStart(self)
    def getRtRegionEnd(self): return _msparser.ms_xic_getRtRegionEnd(self)
    def getNumPoints(self): return _msparser.ms_xic_getNumPoints(self)
    def getPoint(self, *args): return _msparser.ms_xic_getPoint(self, *args)
    __swig_destroy__ = _msparser.delete_ms_xic
    __del__ = lambda self : None;
ms_xic_swigregister = _msparser.ms_xic_swigregister
ms_xic_swigregister(ms_xic)

def ms_xic_getXmlCode(*args):
  return _msparser.ms_xic_getXmlCode(*args)
ms_xic_getXmlCode = _msparser.ms_xic_getXmlCode

def ms_xic_getCodeFromXml(*args):
  return _msparser.ms_xic_getCodeFromXml(*args)
ms_xic_getCodeFromXml = _msparser.ms_xic_getCodeFromXml

class ms_distiller_data(ms_errors):
    __swig_setmethods__ = {}
    for _s in [ms_errors]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_distiller_data, name, value)
    __swig_getmethods__ = {}
    for _s in [ms_errors]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, ms_distiller_data, name)
    __repr__ = _swig_repr
    __swig_getmethods__["getDistillerResfileTimestamp"] = lambda x: _msparser.ms_distiller_data_getDistillerResfileTimestamp
    if _newclass:getDistillerResfileTimestamp = staticmethod(_msparser.ms_distiller_data_getDistillerResfileTimestamp)
    __swig_getmethods__["getDistillerProjectStreamName"] = lambda x: _msparser.ms_distiller_data_getDistillerProjectStreamName
    if _newclass:getDistillerProjectStreamName = staticmethod(_msparser.ms_distiller_data_getDistillerProjectStreamName)
    def getSearchCount(self): return _msparser.ms_distiller_data_getSearchCount(self)
    def getSearch(self, *args): return _msparser.ms_distiller_data_getSearch(self, *args)
    def getQuantCount(self): return _msparser.ms_distiller_data_getQuantCount(self)
    def getQuant(self, *args): return _msparser.ms_distiller_data_getQuant(self, *args)
    def getQuantForSearch(self, *args): return _msparser.ms_distiller_data_getQuantForSearch(self, *args)
    def getDatfile(self): return _msparser.ms_distiller_data_getDatfile(self)
    def getQuantMethod(self): return _msparser.ms_distiller_data_getQuantMethod(self)
    def loadXml(self, *args): return _msparser.ms_distiller_data_loadXml(self, *args)
    def loadXmlFile(self, *args): return _msparser.ms_distiller_data_loadXmlFile(self, *args)
    def __init__(self): 
        this = _msparser.new_ms_distiller_data()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _msparser.delete_ms_distiller_data
    __del__ = lambda self : None;
ms_distiller_data_swigregister = _msparser.ms_distiller_data_swigregister
ms_distiller_data_swigregister(ms_distiller_data)

def ms_distiller_data_getDistillerResfileTimestamp():
  return _msparser.ms_distiller_data_getDistillerResfileTimestamp()
ms_distiller_data_getDistillerResfileTimestamp = _msparser.ms_distiller_data_getDistillerResfileTimestamp

def ms_distiller_data_getDistillerProjectStreamName():
  return _msparser.ms_distiller_data_getDistillerProjectStreamName()
ms_distiller_data_getDistillerProjectStreamName = _msparser.ms_distiller_data_getDistillerProjectStreamName

class ms_distiller_data_quant(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_distiller_data_quant, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ms_distiller_data_quant, name)
    __repr__ = _swig_repr
    def __init__(self): 
        this = _msparser.new_ms_distiller_data_quant()
        try: self.this.append(this)
        except: self.this = this
    def extractXml(self, *args): return _msparser.ms_distiller_data_quant_extractXml(self, *args)
    def getTaskId(self): return _msparser.ms_distiller_data_quant_getTaskId(self)
    def getStreamNumber(self): return _msparser.ms_distiller_data_quant_getStreamNumber(self)
    def getResultsStreamName(self): return _msparser.ms_distiller_data_quant_getResultsStreamName(self)
    def getCacheStreamName(self): return _msparser.ms_distiller_data_quant_getCacheStreamName(self)
    __swig_destroy__ = _msparser.delete_ms_distiller_data_quant
    __del__ = lambda self : None;
ms_distiller_data_quant_swigregister = _msparser.ms_distiller_data_quant_swigregister
ms_distiller_data_quant_swigregister(ms_distiller_data_quant)

class ms_distiller_data_search(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_distiller_data_search, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ms_distiller_data_search, name)
    __repr__ = _swig_repr
    eAuto = _msparser.ms_distiller_data_search_eAuto
    eMudpit = _msparser.ms_distiller_data_search_eMudpit
    eStandard = _msparser.ms_distiller_data_search_eStandard
    eGroupAuto = _msparser.ms_distiller_data_search_eGroupAuto
    eGroupStandard = _msparser.ms_distiller_data_search_eGroupStandard
    eGroupFamily = _msparser.ms_distiller_data_search_eGroupFamily
    def __init__(self): 
        this = _msparser.new_ms_distiller_data_search()
        try: self.this.append(this)
        except: self.this = this
    def extractXml(self, *args): return _msparser.ms_distiller_data_search_extractXml(self, *args)
    def getTaskId(self): return _msparser.ms_distiller_data_search_getTaskId(self)
    def getCacheFileName(self): return _msparser.ms_distiller_data_search_getCacheFileName(self)
    def getQuantMethodXml(self): return _msparser.ms_distiller_data_search_getQuantMethodXml(self)
    def getQuantConfigFile(self): return _msparser.ms_distiller_data_search_getQuantConfigFile(self)
    def getProteinGrouping(self): return _msparser.ms_distiller_data_search_getProteinGrouping(self)
    def getSscoring(self): return _msparser.ms_distiller_data_search_getSscoring(self)
    def getScoreExpectCutOff(self): return _msparser.ms_distiller_data_search_getScoreExpectCutOff(self)
    def getShowSubset(self): return _msparser.ms_distiller_data_search_getShowSubset(self)
    def getShowSubsetFamily(self): return _msparser.ms_distiller_data_search_getShowSubsetFamily(self)
    def getRequireBoldRed(self): return _msparser.ms_distiller_data_search_getRequireBoldRed(self)
    def getSignificanceThreshold(self): return _msparser.ms_distiller_data_search_getSignificanceThreshold(self)
    def getReporttop(self): return _msparser.ms_distiller_data_search_getReporttop(self)
    def getPercolator(self): return _msparser.ms_distiller_data_search_getPercolator(self)
    def getErrTolPeptide(self): return _msparser.ms_distiller_data_search_getErrTolPeptide(self)
    def getPeptideSummaryFlags(self): return _msparser.ms_distiller_data_search_getPeptideSummaryFlags(self)
    def getPeptideSummaryFlags2(self): return _msparser.ms_distiller_data_search_getPeptideSummaryFlags2(self)
    __swig_destroy__ = _msparser.delete_ms_distiller_data_search
    __del__ = lambda self : None;
ms_distiller_data_search_swigregister = _msparser.ms_distiller_data_search_swigregister
ms_distiller_data_search_swigregister(ms_distiller_data_search)

class ms_distiller_master_project(ms_errors):
    __swig_setmethods__ = {}
    for _s in [ms_errors]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_distiller_master_project, name, value)
    __swig_getmethods__ = {}
    for _s in [ms_errors]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, ms_distiller_master_project, name)
    __repr__ = _swig_repr
    __swig_getmethods__["getMasterProjectStreamName"] = lambda x: _msparser.ms_distiller_master_project_getMasterProjectStreamName
    if _newclass:getMasterProjectStreamName = staticmethod(_msparser.ms_distiller_master_project_getMasterProjectStreamName)
    def getNumSubprojects(self): return _msparser.ms_distiller_master_project_getNumSubprojects(self)
    def getSubproject(self, *args): return _msparser.ms_distiller_master_project_getSubproject(self, *args)
    def getNumSearches(self): return _msparser.ms_distiller_master_project_getNumSearches(self)
    def getSearch(self, *args): return _msparser.ms_distiller_master_project_getSearch(self, *args)
    def loadXml(self, *args): return _msparser.ms_distiller_master_project_loadXml(self, *args)
    def loadXmlFile(self, *args): return _msparser.ms_distiller_master_project_loadXmlFile(self, *args)
    def __init__(self): 
        this = _msparser.new_ms_distiller_master_project()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _msparser.delete_ms_distiller_master_project
    __del__ = lambda self : None;
ms_distiller_master_project_swigregister = _msparser.ms_distiller_master_project_swigregister
ms_distiller_master_project_swigregister(ms_distiller_master_project)

def ms_distiller_master_project_getMasterProjectStreamName():
  return _msparser.ms_distiller_master_project_getMasterProjectStreamName()
ms_distiller_master_project_getMasterProjectStreamName = _msparser.ms_distiller_master_project_getMasterProjectStreamName

class ms_distiller_master_search(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_distiller_master_search, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ms_distiller_master_search, name)
    __repr__ = _swig_repr
    def __init__(self): 
        this = _msparser.new_ms_distiller_master_search()
        try: self.this.append(this)
        except: self.this = this
    def extractXml(self, *args): return _msparser.ms_distiller_master_search_extractXml(self, *args)
    def getId(self): return _msparser.ms_distiller_master_search_getId(self)
    def getCacheFilename(self): return _msparser.ms_distiller_master_search_getCacheFilename(self)
    def getCombinedPeptideSummaryCacheStreamName(self): return _msparser.ms_distiller_master_search_getCombinedPeptideSummaryCacheStreamName(self)
    __swig_destroy__ = _msparser.delete_ms_distiller_master_search
    __del__ = lambda self : None;
ms_distiller_master_search_swigregister = _msparser.ms_distiller_master_search_swigregister
ms_distiller_master_search_swigregister(ms_distiller_master_search)

class ms_distiller_search_status(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_distiller_search_status, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ms_distiller_search_status, name)
    __repr__ = _swig_repr
    def __init__(self): 
        this = _msparser.new_ms_distiller_search_status()
        try: self.this.append(this)
        except: self.this = this
    def extractXml(self, *args): return _msparser.ms_distiller_search_status_extractXml(self, *args)
    def getId(self): return _msparser.ms_distiller_search_status_getId(self)
    def getTaskId(self): return _msparser.ms_distiller_search_status_getTaskId(self)
    def getTitle(self): return _msparser.ms_distiller_search_status_getTitle(self)
    def getServer(self): return _msparser.ms_distiller_search_status_getServer(self)
    def getSubmitTime(self): return _msparser.ms_distiller_search_status_getSubmitTime(self)
    def getResultsFile(self): return _msparser.ms_distiller_search_status_getResultsFile(self)
    def getStatusMsg(self): return _msparser.ms_distiller_search_status_getStatusMsg(self)
    def getError(self): return _msparser.ms_distiller_search_status_getError(self)
    def getResfileStreamName(self): return _msparser.ms_distiller_search_status_getResfileStreamName(self)
    def getPeptideSummaryCacheStreamName(self): return _msparser.ms_distiller_search_status_getPeptideSummaryCacheStreamName(self)
    __swig_destroy__ = _msparser.delete_ms_distiller_search_status
    __del__ = lambda self : None;
ms_distiller_search_status_swigregister = _msparser.ms_distiller_search_status_swigregister
ms_distiller_search_status_swigregister(ms_distiller_search_status)

class ms_distiller_search_status_list(ms_errors):
    __swig_setmethods__ = {}
    for _s in [ms_errors]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_distiller_search_status_list, name, value)
    __swig_getmethods__ = {}
    for _s in [ms_errors]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, ms_distiller_search_status_list, name)
    __repr__ = _swig_repr
    __swig_getmethods__["getSearchStatusListStreamName"] = lambda x: _msparser.ms_distiller_search_status_list_getSearchStatusListStreamName
    if _newclass:getSearchStatusListStreamName = staticmethod(_msparser.ms_distiller_search_status_list_getSearchStatusListStreamName)
    def getNumSearches(self): return _msparser.ms_distiller_search_status_list_getNumSearches(self)
    def getSearch(self, *args): return _msparser.ms_distiller_search_status_list_getSearch(self, *args)
    def loadXml(self, *args): return _msparser.ms_distiller_search_status_list_loadXml(self, *args)
    def loadXmlFile(self, *args): return _msparser.ms_distiller_search_status_list_loadXmlFile(self, *args)
    def __init__(self): 
        this = _msparser.new_ms_distiller_search_status_list()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _msparser.delete_ms_distiller_search_status_list
    __del__ = lambda self : None;
ms_distiller_search_status_list_swigregister = _msparser.ms_distiller_search_status_list_swigregister
ms_distiller_search_status_list_swigregister(ms_distiller_search_status_list)

def ms_distiller_search_status_list_getSearchStatusListStreamName():
  return _msparser.ms_distiller_search_status_list_getSearchStatusListStreamName()
ms_distiller_search_status_list_getSearchStatusListStreamName = _msparser.ms_distiller_search_status_list_getSearchStatusListStreamName

class ms_distiller_sub_project(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_distiller_sub_project, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ms_distiller_sub_project, name)
    __repr__ = _swig_repr
    __swig_getmethods__["getResultsListStreamName"] = lambda x: _msparser.ms_distiller_sub_project_getResultsListStreamName
    if _newclass:getResultsListStreamName = staticmethod(_msparser.ms_distiller_sub_project_getResultsListStreamName)
    def __init__(self): 
        this = _msparser.new_ms_distiller_sub_project()
        try: self.this.append(this)
        except: self.this = this
    def extractXml(self, *args): return _msparser.ms_distiller_sub_project_extractXml(self, *args)
    def getId(self): return _msparser.ms_distiller_sub_project_getId(self)
    def getType(self): return _msparser.ms_distiller_sub_project_getType(self)
    def getName(self): return _msparser.ms_distiller_sub_project_getName(self)
    def getRawSampleNumber(self): return _msparser.ms_distiller_sub_project_getRawSampleNumber(self)
    def getRawFormat(self): return _msparser.ms_distiller_sub_project_getRawFormat(self)
    def getRawAbsolutePath(self): return _msparser.ms_distiller_sub_project_getRawAbsolutePath(self)
    def getRawRelativePath(self): return _msparser.ms_distiller_sub_project_getRawRelativePath(self)
    def getProjectRelativePath(self): return _msparser.ms_distiller_sub_project_getProjectRelativePath(self)
    def getHavePeakList(self): return _msparser.ms_distiller_sub_project_getHavePeakList(self)
    __swig_destroy__ = _msparser.delete_ms_distiller_sub_project
    __del__ = lambda self : None;
ms_distiller_sub_project_swigregister = _msparser.ms_distiller_sub_project_swigregister
ms_distiller_sub_project_swigregister(ms_distiller_sub_project)

def ms_distiller_sub_project_getResultsListStreamName():
  return _msparser.ms_distiller_sub_project_getResultsListStreamName()
ms_distiller_sub_project_getResultsListStreamName = _msparser.ms_distiller_sub_project_getResultsListStreamName

class ms_fitexy_result(ms_handle):
    __swig_setmethods__ = {}
    for _s in [ms_handle]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_fitexy_result, name, value)
    __swig_getmethods__ = {}
    for _s in [ms_handle]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, ms_fitexy_result, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _msparser.new_ms_fitexy_result(*args)
        try: self.this.append(this)
        except: self.this = this
    def getSigmaX(self): return _msparser.ms_fitexy_result_getSigmaX(self)
    def getSigmaY(self): return _msparser.ms_fitexy_result_getSigmaY(self)
    def getA(self): return _msparser.ms_fitexy_result_getA(self)
    def getSigmaA(self): return _msparser.ms_fitexy_result_getSigmaA(self)
    def getB(self): return _msparser.ms_fitexy_result_getB(self)
    def getSigmaB(self): return _msparser.ms_fitexy_result_getSigmaB(self)
    def getChi2(self): return _msparser.ms_fitexy_result_getChi2(self)
    def getQ(self): return _msparser.ms_fitexy_result_getQ(self)
    __swig_destroy__ = _msparser.delete_ms_fitexy_result
    __del__ = lambda self : None;
ms_fitexy_result_swigregister = _msparser.ms_fitexy_result_swigregister
ms_fitexy_result_swigregister(ms_fitexy_result)

class ms_ms1quant_average_results(ms_handle):
    __swig_setmethods__ = {}
    for _s in [ms_handle]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_ms1quant_average_results, name, value)
    __swig_getmethods__ = {}
    for _s in [ms_handle]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, ms_ms1quant_average_results, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _msparser.new_ms_ms1quant_average_results(*args)
        try: self.this.append(this)
        except: self.this = this
    def getReferenceHitId(self): return _msparser.ms_ms1quant_average_results_getReferenceHitId(self)
    def getReferenceMemberNumber(self): return _msparser.ms_ms1quant_average_results_getReferenceMemberNumber(self)
    def isReferenceUserSelected(self): return _msparser.ms_ms1quant_average_results_isReferenceUserSelected(self)
    __swig_destroy__ = _msparser.delete_ms_ms1quant_average_results
    __del__ = lambda self : None;
ms_ms1quant_average_results_swigregister = _msparser.ms_ms1quant_average_results_swigregister
ms_ms1quant_average_results_swigregister(ms_ms1quant_average_results)

class ms_ms1quant_charge_state(ms_handle):
    __swig_setmethods__ = {}
    for _s in [ms_handle]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_ms1quant_charge_state, name, value)
    __swig_getmethods__ = {}
    for _s in [ms_handle]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, ms_ms1quant_charge_state, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _msparser.new_ms_ms1quant_charge_state(*args)
        try: self.this.append(this)
        except: self.this = this
    def getCorrectedMinSPPwidth(self): return _msparser.ms_ms1quant_charge_state_getCorrectedMinSPPwidth(self)
    def getCorrectedMaxSPPwidth(self): return _msparser.ms_ms1quant_charge_state_getCorrectedMaxSPPwidth(self)
    def getCorrectedSPPwidth(self): return _msparser.ms_ms1quant_charge_state_getCorrectedSPPwidth(self)
    def getBucketWidth(self): return _msparser.ms_ms1quant_charge_state_getBucketWidth(self)
    def getMaxAlignment(self): return _msparser.ms_ms1quant_charge_state_getMaxAlignment(self)
    def getMatchedRho(self): return _msparser.ms_ms1quant_charge_state_getMatchedRho(self)
    def getMatchedFraction(self): return _msparser.ms_ms1quant_charge_state_getMatchedFraction(self)
    def getTotalIntensity(self): return _msparser.ms_ms1quant_charge_state_getTotalIntensity(self)
    def getNumberOfBuckets(self): return _msparser.ms_ms1quant_charge_state_getNumberOfBuckets(self)
    def getBucket(self, *args): return _msparser.ms_ms1quant_charge_state_getBucket(self, *args)
    def getCalcMz(self): return _msparser.ms_ms1quant_charge_state_getCalcMz(self)
    __swig_destroy__ = _msparser.delete_ms_ms1quant_charge_state
    __del__ = lambda self : None;
ms_ms1quant_charge_state_swigregister = _msparser.ms_ms1quant_charge_state_swigregister
ms_ms1quant_charge_state_swigregister(ms_ms1quant_charge_state)

class ms_ms1quant_peptide_status(ms_handle):
    __swig_setmethods__ = {}
    for _s in [ms_handle]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_ms1quant_peptide_status, name, value)
    __swig_getmethods__ = {}
    for _s in [ms_handle]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, ms_ms1quant_peptide_status, name)
    __repr__ = _swig_repr
    PS_OK = _msparser.ms_ms1quant_peptide_status_PS_OK
    PS_EXPECTGREATERTHAN = _msparser.ms_ms1quant_peptide_status_PS_EXPECTGREATERTHAN
    PS_LESSTHANIDENTITY = _msparser.ms_ms1quant_peptide_status_PS_LESSTHANIDENTITY
    PS_MINCHARGE = _msparser.ms_ms1quant_peptide_status_PS_MINCHARGE
    PS_NOTUNIQUE = _msparser.ms_ms1quant_peptide_status_PS_NOTUNIQUE
    PS_SCORELESSHOMOLOGY = _msparser.ms_ms1quant_peptide_status_PS_SCORELESSHOMOLOGY
    PS_SCORELESSIDENTITY_NOHOMO = _msparser.ms_ms1quant_peptide_status_PS_SCORELESSIDENTITY_NOHOMO
    PS_SCORELESSTHRESHOLD = _msparser.ms_ms1quant_peptide_status_PS_SCORELESSTHRESHOLD
    PS_EXCLUDE_LOCALDEF = _msparser.ms_ms1quant_peptide_status_PS_EXCLUDE_LOCALDEF
    PS_EXCLUDE_MODFILE = _msparser.ms_ms1quant_peptide_status_PS_EXCLUDE_MODFILE
    PS_EXCLUDE_UNMODIFIED = _msparser.ms_ms1quant_peptide_status_PS_EXCLUDE_UNMODIFIED
    PS_NOTPARTOFQUANTITATION = _msparser.ms_ms1quant_peptide_status_PS_NOTPARTOFQUANTITATION
    PS_MAX = _msparser.ms_ms1quant_peptide_status_PS_MAX
    __swig_getmethods__["getXmlCode"] = lambda x: _msparser.ms_ms1quant_peptide_status_getXmlCode
    if _newclass:getXmlCode = staticmethod(_msparser.ms_ms1quant_peptide_status_getXmlCode)
    __swig_getmethods__["getCodeFromXml"] = lambda x: _msparser.ms_ms1quant_peptide_status_getCodeFromXml
    if _newclass:getCodeFromXml = staticmethod(_msparser.ms_ms1quant_peptide_status_getCodeFromXml)
    def __init__(self, *args): 
        this = _msparser.new_ms_ms1quant_peptide_status(*args)
        try: self.this.append(this)
        except: self.this = this
    def getQuery(self): return _msparser.ms_ms1quant_peptide_status_getQuery(self)
    def getRank(self): return _msparser.ms_ms1quant_peptide_status_getRank(self)
    def getComponent(self): return _msparser.ms_ms1quant_peptide_status_getComponent(self)
    def getStatus(self): return _msparser.ms_ms1quant_peptide_status_getStatus(self)
    __swig_destroy__ = _msparser.delete_ms_ms1quant_peptide_status
    __del__ = lambda self : None;
ms_ms1quant_peptide_status_swigregister = _msparser.ms_ms1quant_peptide_status_swigregister
ms_ms1quant_peptide_status_swigregister(ms_ms1quant_peptide_status)

def ms_ms1quant_peptide_status_getXmlCode(*args):
  return _msparser.ms_ms1quant_peptide_status_getXmlCode(*args)
ms_ms1quant_peptide_status_getXmlCode = _msparser.ms_ms1quant_peptide_status_getXmlCode

def ms_ms1quant_peptide_status_getCodeFromXml(*args):
  return _msparser.ms_ms1quant_peptide_status_getCodeFromXml(*args)
ms_ms1quant_peptide_status_getCodeFromXml = _msparser.ms_ms1quant_peptide_status_getCodeFromXml

class ms_ms1quant_match_range(ms_handle):
    __swig_setmethods__ = {}
    for _s in [ms_handle]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_ms1quant_match_range, name, value)
    __swig_getmethods__ = {}
    for _s in [ms_handle]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, ms_ms1quant_match_range, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _msparser.new_ms_ms1quant_match_range(*args)
        try: self.this.append(this)
        except: self.this = this
    def getRt(self, *args): return _msparser.ms_ms1quant_match_range_getRt(self, *args)
    def getScan(self, *args): return _msparser.ms_ms1quant_match_range_getScan(self, *args)
    __swig_destroy__ = _msparser.delete_ms_ms1quant_match_range
    __del__ = lambda self : None;
ms_ms1quant_match_range_swigregister = _msparser.ms_ms1quant_match_range_swigregister
ms_ms1quant_match_range_swigregister(ms_ms1quant_match_range)

class ms_ms1quant_match_component(ms_handle):
    __swig_setmethods__ = {}
    for _s in [ms_handle]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_ms1quant_match_component, name, value)
    __swig_getmethods__ = {}
    for _s in [ms_handle]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, ms_ms1quant_match_component, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _msparser.new_ms_ms1quant_match_component(*args)
        try: self.this.append(this)
        except: self.this = this
    def getComponent(self): return _msparser.ms_ms1quant_match_component_getComponent(self)
    def isComponentIdentified(self): return _msparser.ms_ms1quant_match_component_isComponentIdentified(self)
    def getRelativeMass(self): return _msparser.ms_ms1quant_match_component_getRelativeMass(self)
    def getMoverz(self): return _msparser.ms_ms1quant_match_component_getMoverz(self)
    def hasAbsoluteValue(self): return _msparser.ms_ms1quant_match_component_hasAbsoluteValue(self)
    def getAbsoluteValue(self): return _msparser.ms_ms1quant_match_component_getAbsoluteValue(self)
    def getXic(self): return _msparser.ms_ms1quant_match_component_getXic(self)
    def getNumRanges(self): return _msparser.ms_ms1quant_match_component_getNumRanges(self)
    def getRange(self, *args): return _msparser.ms_ms1quant_match_component_getRange(self, *args)
    def getNumPeptides(self): return _msparser.ms_ms1quant_match_component_getNumPeptides(self)
    def getPeptideKey(self, *args): return _msparser.ms_ms1quant_match_component_getPeptideKey(self, *args)
    __swig_destroy__ = _msparser.delete_ms_ms1quant_match_component
    __del__ = lambda self : None;
ms_ms1quant_match_component_swigregister = _msparser.ms_ms1quant_match_component_swigregister
ms_ms1quant_match_component_swigregister(ms_ms1quant_match_component)

class ms_ms1quant_match_ratio(ms_handle):
    __swig_setmethods__ = {}
    for _s in [ms_handle]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_ms1quant_match_ratio, name, value)
    __swig_getmethods__ = {}
    for _s in [ms_handle]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, ms_ms1quant_match_ratio, name)
    __repr__ = _swig_repr
    RS_EMPTY = _msparser.ms_ms1quant_match_ratio_RS_EMPTY
    RS_OK = _msparser.ms_ms1quant_match_ratio_RS_OK
    RS_ISOLATEDPRECURSORFAILED = _msparser.ms_ms1quant_match_ratio_RS_ISOLATEDPRECURSORFAILED
    RS_INTEFERENCEFAILED = _msparser.ms_ms1quant_match_ratio_RS_INTEFERENCEFAILED
    RS_NODATA = _msparser.ms_ms1quant_match_ratio_RS_NODATA
    RS_FITEXYSIGMA = _msparser.ms_ms1quant_match_ratio_RS_FITEXYSIGMA
    RS_NEGATIVERATIO = _msparser.ms_ms1quant_match_ratio_RS_NEGATIVERATIO
    RS_INFINITERATIO = _msparser.ms_ms1quant_match_ratio_RS_INFINITERATIO
    RS_ZERORATIO = _msparser.ms_ms1quant_match_ratio_RS_ZERORATIO
    RS_OUTLIER = _msparser.ms_ms1quant_match_ratio_RS_OUTLIER
    __swig_getmethods__["getXmlCode"] = lambda x: _msparser.ms_ms1quant_match_ratio_getXmlCode
    if _newclass:getXmlCode = staticmethod(_msparser.ms_ms1quant_match_ratio_getXmlCode)
    __swig_getmethods__["getCodeFromXml"] = lambda x: _msparser.ms_ms1quant_match_ratio_getCodeFromXml
    if _newclass:getCodeFromXml = staticmethod(_msparser.ms_ms1quant_match_ratio_getCodeFromXml)
    __swig_getmethods__["getCodeInfo"] = lambda x: _msparser.ms_ms1quant_match_ratio_getCodeInfo
    if _newclass:getCodeInfo = staticmethod(_msparser.ms_ms1quant_match_ratio_getCodeInfo)
    def __init__(self, *args): 
        this = _msparser.new_ms_ms1quant_match_ratio(*args)
        try: self.this.append(this)
        except: self.this = this
    def getRatioName(self): return _msparser.ms_ms1quant_match_ratio_getRatioName(self)
    def isSet(self): return _msparser.ms_ms1quant_match_ratio_isSet(self)
    def getValue(self): return _msparser.ms_ms1quant_match_ratio_getValue(self)
    def getQuality(self): return _msparser.ms_ms1quant_match_ratio_getQuality(self)
    def isValid(self): return _msparser.ms_ms1quant_match_ratio_isValid(self)
    def isUsedForAverage(self): return _msparser.ms_ms1quant_match_ratio_isUsedForAverage(self)
    def isIncluded(self): return _msparser.ms_ms1quant_match_ratio_isIncluded(self)
    def getFitexy(self, *args): return _msparser.ms_ms1quant_match_ratio_getFitexy(self, *args)
    def getStatus(self): return _msparser.ms_ms1quant_match_ratio_getStatus(self)
    def getStatusList(self): return _msparser.ms_ms1quant_match_ratio_getStatusList(self)
    __swig_destroy__ = _msparser.delete_ms_ms1quant_match_ratio
    __del__ = lambda self : None;
ms_ms1quant_match_ratio_swigregister = _msparser.ms_ms1quant_match_ratio_swigregister
ms_ms1quant_match_ratio_swigregister(ms_ms1quant_match_ratio)

def ms_ms1quant_match_ratio_getXmlCode(*args):
  return _msparser.ms_ms1quant_match_ratio_getXmlCode(*args)
ms_ms1quant_match_ratio_getXmlCode = _msparser.ms_ms1quant_match_ratio_getXmlCode

def ms_ms1quant_match_ratio_getCodeFromXml(*args):
  return _msparser.ms_ms1quant_match_ratio_getCodeFromXml(*args)
ms_ms1quant_match_ratio_getCodeFromXml = _msparser.ms_ms1quant_match_ratio_getCodeFromXml

def ms_ms1quant_match_ratio_getCodeInfo(*args):
  return _msparser.ms_ms1quant_match_ratio_getCodeInfo(*args)
ms_ms1quant_match_ratio_getCodeInfo = _msparser.ms_ms1quant_match_ratio_getCodeInfo

class ms_ms1quant_match(ms_handle):
    __swig_setmethods__ = {}
    for _s in [ms_handle]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_ms1quant_match, name, value)
    __swig_getmethods__ = {}
    for _s in [ms_handle]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, ms_ms1quant_match, name)
    __repr__ = _swig_repr
    CHARGETYPE_ORIGINAL = _msparser.ms_ms1quant_match_CHARGETYPE_ORIGINAL
    CHARGETYPE_ALL = _msparser.ms_ms1quant_match_CHARGETYPE_ALL
    __swig_getmethods__["getXmlCode"] = lambda x: _msparser.ms_ms1quant_match_getXmlCode
    if _newclass:getXmlCode = staticmethod(_msparser.ms_ms1quant_match_getXmlCode)
    __swig_getmethods__["getCodeFromXml"] = lambda x: _msparser.ms_ms1quant_match_getCodeFromXml
    if _newclass:getCodeFromXml = staticmethod(_msparser.ms_ms1quant_match_getCodeFromXml)
    def __init__(self, *args): 
        this = _msparser.new_ms_ms1quant_match(*args)
        try: self.this.append(this)
        except: self.this = this
    def getKey(self): return _msparser.ms_ms1quant_match_getKey(self)
    def getPeptideString(self): return _msparser.ms_ms1quant_match_getPeptideString(self)
    def getVarMods(self): return _msparser.ms_ms1quant_match_getVarMods(self)
    def getFirstXicScanId(self): return _msparser.ms_ms1quant_match_getFirstXicScanId(self)
    def getLastXicScanId(self): return _msparser.ms_ms1quant_match_getLastXicScanId(self)
    def getDisplayIntensity(self): return _msparser.ms_ms1quant_match_getDisplayIntensity(self)
    def getChargeState(self): return _msparser.ms_ms1quant_match_getChargeState(self)
    def getChargeType(self): return _msparser.ms_ms1quant_match_getChargeType(self)
    def getReadableLabelFreeVarMods(self): return _msparser.ms_ms1quant_match_getReadableLabelFreeVarMods(self)
    def getConciseLabelFreeVarMods(self): return _msparser.ms_ms1quant_match_getConciseLabelFreeVarMods(self)
    def getDataSourceId(self): return _msparser.ms_ms1quant_match_getDataSourceId(self)
    def getCorrectionMatrix(self): return _msparser.ms_ms1quant_match_getCorrectionMatrix(self)
    def getPerfectObservedMatrix(self): return _msparser.ms_ms1quant_match_getPerfectObservedMatrix(self)
    def getPredictionMatrix(self): return _msparser.ms_ms1quant_match_getPredictionMatrix(self)
    def getNumHits(self): return _msparser.ms_ms1quant_match_getNumHits(self)
    def getHit(self, *args): return _msparser.ms_ms1quant_match_getHit(self, *args)
    def getNumComponents(self): return _msparser.ms_ms1quant_match_getNumComponents(self)
    def hasComponent(self, *args): return _msparser.ms_ms1quant_match_hasComponent(self, *args)
    def getComponent(self, *args): return _msparser.ms_ms1quant_match_getComponent(self, *args)
    def getNumPeptideRatios(self): return _msparser.ms_ms1quant_match_getNumPeptideRatios(self)
    def hasPeptideRatio(self, *args): return _msparser.ms_ms1quant_match_hasPeptideRatio(self, *args)
    def getPeptideRatio(self, *args): return _msparser.ms_ms1quant_match_getPeptideRatio(self, *args)
    def getChargeStateData(self): return _msparser.ms_ms1quant_match_getChargeStateData(self)
    def isHitRatioOutlier(self, *args): return _msparser.ms_ms1quant_match_isHitRatioOutlier(self, *args)
    def isHitRatioUsedForAverage(self, *args): return _msparser.ms_ms1quant_match_isHitRatioUsedForAverage(self, *args)
    def isHitRatioExcluded(self, *args): return _msparser.ms_ms1quant_match_isHitRatioExcluded(self, *args)
    __swig_destroy__ = _msparser.delete_ms_ms1quant_match
    __del__ = lambda self : None;
ms_ms1quant_match_swigregister = _msparser.ms_ms1quant_match_swigregister
ms_ms1quant_match_swigregister(ms_ms1quant_match)

def ms_ms1quant_match_getXmlCode(*args):
  return _msparser.ms_ms1quant_match_getXmlCode(*args)
ms_ms1quant_match_getXmlCode = _msparser.ms_ms1quant_match_getXmlCode

def ms_ms1quant_match_getCodeFromXml(*args):
  return _msparser.ms_ms1quant_match_getCodeFromXml(*args)
ms_ms1quant_match_getCodeFromXml = _msparser.ms_ms1quant_match_getCodeFromXml

class ms_ms1quantitation(ms_customquantitation):
    __swig_setmethods__ = {}
    for _s in [ms_customquantitation]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ms_ms1quantitation, name, value)
    __swig_getmethods__ = {}
    for _s in [ms_customquantitation]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, ms_ms1quantitation, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _msparser.new_ms_ms1quantitation(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _msparser.delete_ms_ms1quantitation
    __del__ = lambda self : None;
    def getNumPeptideStatuses(self): return _msparser.ms_ms1quantitation_getNumPeptideStatuses(self)
    def getPeptideStatus(self, *args): return _msparser.ms_ms1quantitation_getPeptideStatus(self, *args)
    def getNumMatches(self): return _msparser.ms_ms1quantitation_getNumMatches(self)
    def getMatch(self, *args): return _msparser.ms_ms1quantitation_getMatch(self, *args)
    def findPeptideStatus(self, *args): return _msparser.ms_ms1quantitation_findPeptideStatus(self, *args)
    def findMatch(self, *args): return _msparser.ms_ms1quantitation_findMatch(self, *args)
    def getAverageResults(self): return _msparser.ms_ms1quantitation_getAverageResults(self)
    def loadXmlFile(self, *args): return _msparser.ms_ms1quantitation_loadXmlFile(self, *args)
    def saveXmlFile(self, *args): return _msparser.ms_ms1quantitation_saveXmlFile(self, *args)
    def loadCdbFile(self, *args): return _msparser.ms_ms1quantitation_loadCdbFile(self, *args)
    def saveCdbFile(self, *args): return _msparser.ms_ms1quantitation_saveCdbFile(self, *args)
    def getSummary(self): return _msparser.ms_ms1quantitation_getSummary(self)
    def getReadableVarMods(self, *args): return _msparser.ms_ms1quantitation_getReadableVarMods(self, *args)
    def getReadableVarModsConcise(self, *args): return _msparser.ms_ms1quantitation_getReadableVarModsConcise(self, *args)
    def getLabelFree(self, *args): return _msparser.ms_ms1quantitation_getLabelFree(self, *args)
    def getNumMatchesForHit(self, *args): return _msparser.ms_ms1quantitation_getNumMatchesForHit(self, *args)
    def getMatchForHit(self, *args): return _msparser.ms_ms1quantitation_getMatchForHit(self, *args)
    def getProteinRatio(self, *args): return _msparser.ms_ms1quantitation_getProteinRatio(self, *args)
    def isAverageProtocol(self): return _msparser.ms_ms1quantitation_isAverageProtocol(self)
    def setAverageReferenceProtein(self, *args): return _msparser.ms_ms1quantitation_setAverageReferenceProtein(self, *args)
    def setAverageNumPeptides(self, num=3): return _msparser.ms_ms1quantitation_setAverageNumPeptides(self, num)
    def setAverageSelection(self, *args): return _msparser.ms_ms1quantitation_setAverageSelection(self, *args)
    def getAveragePeptideIntensity(self, *args): return _msparser.ms_ms1quantitation_getAveragePeptideIntensity(self, *args)
ms_ms1quantitation_swigregister = _msparser.ms_ms1quantitation_swigregister
ms_ms1quantitation_swigregister(ms_ms1quantitation)
